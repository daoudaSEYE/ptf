...
class locationController extends Controller
{
    function index()
    {
     $locations = DB::table('listings')->where('categorie', '=', 'location')->orderBy('id', 'asc')->paginate(6);
	...
	$categories= DB::table('categories')->get();
	 return view('location', compact('locations', 'lieux', 'categories', 'firstFourPlaces', 'lastFourPlaces'));
    }
    ...
    function fetch_locations(Request $request)
    {
     if($request->ajax())
     {
      ...
      $locations = DB::table('listings')
                    ...
                    ->paginate(5);
	$lieux= DB::table('lieux')->get();
      return view('pagination_locations', compact('locations', 'lieux'))->render();
     }
    }
}
?>
